...
namespace cheat {
	...
	cs2_internal::cs2_internal() : inited(false), d3d_device(nullptr), swap_chain(nullptr), d3d_context(nullptr), d3d_view(nullptr),
		...
		esp_on(false), teammate_esp(false), skeleton(false), health(false), name(false), box(false), eye_ray(false), spectator_list(false), esp_color(ImVec4(1.0f, 0.0f, 0.0f, 1.0f)),
		unloading(false)
	{
